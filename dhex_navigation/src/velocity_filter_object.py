...
class VelocityFilter():
  ...
  def __init__(self, alpha):
    rospy.init_node('velocity_filter_object', anonymous=True)

    self.pub = rospy.Publisher('/cmd_vel_object', Twist, queue_size=1)

    self.sub = rospy.Subscriber("/move_base_object/cmd_vel", Twist, self.callback)
